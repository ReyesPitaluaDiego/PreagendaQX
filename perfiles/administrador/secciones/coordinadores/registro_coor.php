...
<body>
    ...
    <form id="form_registro" name="form_registro" class="form_registro ancho1" action="../../../../crud/create_coor.php" method="post">
        <div class="contform_3">
            <p class="titulo_form">Datos del coordinador</p>
            <input type="text" name="usuario" id="usuario" value="Coordinador" hidden>
