...
<head>
    ...
    <title>Solicitud de transfusión</title>
</head>
<body onload="procesarCheckbox()">
    <?php
     include "../../header.php";
    ?>
    ...
    <br>
    <!-- FORMULARIO BANCO DE SANGRE (solicitud de transfusión) -->
    <?php
     include "../../../../templates/form_bancosangre.php";
    ?>
</body>
</html>