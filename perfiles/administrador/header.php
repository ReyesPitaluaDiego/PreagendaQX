...
?>
    <header>
        ...
        <div class="header1 header2">
            <div class="contenido_hed1 cont1"><div class="tipo_perfil"><i class="fa-regular fa-user-gear"></i><p>Perfil de:<br>Administrador</p></div></div>
            <div class="contenido_hed1 cont2 fecha">
            <script src="../../../../js/main.js">fecha;</script>
            </div>
            <div class="contenido_hed1 cont3"><a href="../../index.php"><i class="fa-solid fa-house"></i></a></div>
            </div>
        </div>
    </header>