...
<head>
    ...
    <title>Cirugías - Coordinador</title>
</head>
<body>
    <header>
        <div class="header1">
        ...
        <div class="header1 header2">
            <div class="contenido_hed1 cont1"><div class="tipo_perfil"><i class="fa-solid fa-hospital-user icon_open"></i><p>Perfil de:<br>Coordinador</p></div><div class="usuario_contraseña"><a href="#" id="open_modal">Cambiar contraseña</a></div></div>
    ...
    <section class="contenedor_menu ancho1">
        ...
        <article class="opcion_menu">
            <figure><img src="../../img/img_consentimientos.jpg" alt=""></figure>
            <div class="btn_menu"><a href="secciones/consentimientos/registro_consentimiento.php">Consentimientos</a></div>
        </article>
