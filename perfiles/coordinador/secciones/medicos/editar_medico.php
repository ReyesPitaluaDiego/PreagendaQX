<?php
    ...
    $empleado = $_GET['id'];
    $consulta = "SELECT * FROM medicos WHERE NoEMPLEADO = '$empleado'";
...
<body>
    ...
    <form id="form_registro" name="form_registro" class="form_registro ancho1" action="../../../../crud/update_medico.php" method="post">
        <div class="contform_3">
            ...
            <div class="form_group">
                ...
                <label for="area">Área que coordina: <span class="rojo">*</span><br>
                    <input type="text" readonly name="area" id="area" value="<?php echo $fila["AREA"]; ?>">
                </label>
            </div>
            <!-- ---------------------------------------------------------- -->
            <div class="form_group">
