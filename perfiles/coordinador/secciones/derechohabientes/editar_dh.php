<?php
    ...
    if ($tipouser=='Coordinador'){
      $cirugia = '<label for="fecha_cirugia" class="form_row6">Fecha de cirugía:<br><input type="date" name="fecha_cirugia"id="fecha_cirugia" value="'.$fila["FECHA_CIRUGIA"].'">
      </label>
      <label for="sala">Sala:<br>
      <select name="sala" id="sala">'.$sala.'
      ...
      <input type="time" name="hora"id="hora" value="'.$fila["HORA"].'">
      </label>';
    }
?>
<!DOCTYPE html>
