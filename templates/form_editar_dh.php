<form id="form_registro" name="form_registro" class="form_registro ancho1" action="../../../../crud/update_dh.php" method="post">
        <div class="contform_1">
            ...
            <div class="form_group">
                ...
                <label for="cedula" class="form_row1">Cédula: <span class="rojo">*</span><br>
                    <input type="text" name="cedula" id="cedula" maxlength="10" onkeyup="mayus(this);" value="<?php echo $fila["CEDULA"];?>">
                </label>
                <label for="clave_dh" class="form_row1_1">Tipo beneficiario: <span class="rojo">*</span><br>
                    <select name="clave_dh" id="clave_dh">
                        <option selected="<?php echo $fila["TIPO_BENEFICIARIO"];?>"><?php echo $fila["TIPO_BENEFICIARIO"];?></option>
            ...
            <div class="form_group">
                <label for="edad" class="form_row3">Edad: <span class="rojo">*</span><br>
                    <input type="text" name="edad" id="edad" maxlength="3" pattern="(0-9)" value="<?php echo $fila["EDAD"];?>">
                </label>
            ...
            <div class="form_group">
                <label for="telefono1" class="form_row4">Teléfono 1: <span class="rojo">*</span><br>
                    <input type="tel" name="telefono1" id="telefono1" maxlength="10" value="<?php echo $fila["TELEFONO1"];?>">
                </label>
                <label for="telefono2" class="form_row4">Teléfono 2:<br>
                    <input type="tel" name="telefono2" id="telefono2" maxlength="10" value="<?php echo $fila["TELEFONO2"];?>">
                </label>
            </div>
            <!-- ---------------------------------------------------------- -->
            <div class="form_group">
                <label for="domicilio" class="domicilio">Domicilio: <span class="rojo">*</span><br>
                    <input type="text" name="domicilio" id="domicilio" onkeyup="capitalice(this);" class="capitalice" value="<?php echo $fila["DOMICILIO"];?>">
                </label>
            </div>
            <!-- ---------------------------------------------------------- -->
            <div class="form_group">
                <label for="uemisora">Unidad emisora: <span class="rojo">*</span><br>
                    <select name="uemisora" id="uemisora">
                        <option selected="<?php echo $fila["UNIDAD"];?>"><?php echo $fila["UNIDAD"];?></option>
        ...
        <div class="contform_2">
            ...
            <div class="form_group">
                <label for="diagnostico" class="form_row5">Diagnóstico: <span class="rojo">*</span><br>
                    <textarea name="diagnostico" id="diagnostico" onkeyup="mayus(this);"><?php echo $fila["DIAGNOSTICO"];?></textarea>
                </label>
                <label for="cirugia" class="form_row5">Cirugía proyectada: <span class="rojo">*</span><br>
                    <textarea name="cirugia" id="cirugia" onkeyup="mayus(this);"><?php echo $fila["CIRUGIA"];?></textarea>
                </label>
            </div>
            <!-- ---------------------------------------------------------- -->
            <div class="form_group">
                <label for="numero_medico" class="form_row6">No. Médico tratante: <span class="rojo">*</span><br>
                    <input type="text" name="numero_medico" id="numero_medico" value="<?php echo $fila["NoEMPLEADO"];?>">
                </label>
                <label for="nombre_medico" class="form_row6_6">Médico tratante: <span class="rojo">*</span><br>
                    <input type="text" name="nombre_medico" id="nombre_medico" onkeyup="capitalice(this);" value="<?php echo $fila["MEDICO"];?>">
                </label>
            </div>
            <!-- ---------------------------------------------------------- -->
            <div class="form_group">
                <label for="nombre_coor" class="form_row6_6">Coordinador médico: <span class="rojo">*</span><br>
                    <input type="text" name="nombre_coor" id="nombre_coor" onkeyup="capitalice(this);" value="<?php echo $fila["COORDINADOR"];?>">
                </label>
                <label for="fecha" class="form_row6">Fecha de registro: <span class="rojo">*</span><br>
                    <input type="date" name="fecha" id="fecha" value="<?php echo $fila["FECHA_REGISTRO"];?>">
                </label>
            </div>
            <!-- ---------------------------------------------------------- -->
            <div class="form_group">
                <label for="observaciones" class="form_observaciones2">
                    Observaciones:<br>
                    <textarea name="observaciones" id="observaciones" onkeyup="mayus(this);" placeholder="Observaciones después de cirugía."><?php echo $fila["OBSERVACIONES"];?></textarea>
                </label>
            </div>
            <!-- ---------------------------------------------------------- -->
            <div class="form_group">
            ...
            <p class="notas"> <span class="rojo">*</span> Para modificar algún dato, sobreescriba la información en el campo deseado y oprima el botón Modificar.</p>
        </div>
    </form>
    <!-- Funciones JS -->
    <script>
