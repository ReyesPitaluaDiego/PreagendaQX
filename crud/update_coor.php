<?php
  ...
  $consulta = "UPDATE coordinadores SET NoEMPLEADO='$noempleado', NOMBRE='$nombre', PRIMER_APELLIDO='$apellido1', SEGUNDO_APELLIDO='$apellido2', SEXO='$sexo', CURP='$curp', ESPECIALIDAD='$especialidad', CEDULA_PROFESIONAL='$cedulap', CEDULA_ESPECIALIDAD='$cedulae', COORDINACION='$area' WHERE NoEMPLEADO='$noempleadoactual'";
